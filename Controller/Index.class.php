    ...
    class Index extends FLController {
        public function run () {
            ...
            if ($_GET['id']) {
                ...
                exit (json_encode (array ('code' => 1, 'danmaku' => $ret)));
            } else {
                ...
                if ($add) {
                    ...
                    exit (json_encode (array ('code' => 1, 'data' => $ret)));
                } else {
                    exit (json_encode (array ('code' => 0, 'msg' => 'Error happens, please contact system administrator.')));
                }
            }
        }
    }